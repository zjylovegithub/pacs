...
export class StudiesComponent implements OnDestroy,OnInit{
    ...
    * */
    ...
    savePatient(){
        ...
        let $this = this;
        //if(oldPatientID === $this.service.getPatientId(patient.attrs)){
        ...
        //}
        $this.modifyPatientObj.attrs['00100010'].Value[0]['Alphabetic'] = $this.editPatientName;
        $this.modifyPatientObj.attrs['00100040'].Value[0] = $this.selectedSex;
        $this.modifyPatientObj.attrs['00100020'].Value[0] = $this.editPatientNo;
        $this.modifyPatientObj.attrs['00101010'].Value[0] = $this.editPatientAge;
        $this.modifyPatientObj.attrs['00080061'].Value[0] = $this.editModality;
        $this.modifyPatientObj.attrs['00080020'].Value[0] = $this.editStudyDate;
        $this.modifyPatientObj.attrs['00200010'].Value[0] = $this.editAccessionNumber;
        $this.modifyPatientObj.attrs['00180015'].Value[0] = $this.editBodyPartExamined;
        //$this.modifyPatientObj.attrs['00081040'].Value[0] = $this.editInstitutionalDepartmentName;
        //$this.modifyPatientObj.attrs['00080090'].Value[0] = $this.editReferringPhysicianName;
